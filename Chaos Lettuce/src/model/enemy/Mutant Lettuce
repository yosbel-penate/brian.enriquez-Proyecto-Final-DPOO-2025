...
public class MutantLettuce extends Enemy {

    public MutantLettuce(int healthPoints, int damage, int resistence, int actionRank, int damageS, float damageC, String name, int actionRankS, int moveRank, Position position, String symbol, String description, boolean visibility, String id, String skillname) {
        ...
        this.damage = 20;
        this.damageS = 25;
        this.description = "Una lechuga corrupta que utiliza el dolor de los demás para curarse";
        this.moveRank = 2;
        this.name = "Mutant Lettuce";
        this.visibility = true;
        this.skillname = "Devore";

    }

    public MutantLettuce() {
        super();
    }

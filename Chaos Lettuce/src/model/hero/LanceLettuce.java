...
public class LanceLettuce extends Hero {

    public LanceLettuce(int healthPoints, int damage, int resistence, int actionRank, int damageS, float damageC, String name, int actionRankS, int moveRank, Position position, String symbol, String description, boolean visibility, String id, String skillname) {
        ...
        this.damage = 15;
        this.damageS = 25;
        this.description = "Un honesto caballero que pelea por sus compañeros";
        this.moveRank = 4;
        this.name = "Lance Lettuce";
        this.visibility = true;
        this.skillname = "Leaf Sword";
    }

    public LanceLettuce(String name, String description, String symbol, int healthPoints) {
    ...
    public void setParametersInitialDefault() {
    	try {
 			this.symbol=ImageIO.read(getClass().getResource("/resource/heros/LanceLettuce.png"));
 		} catch (IOException e) {
